 ...
 * @param size Size (width and height) of the crosshair in pixels (optional)
 * @param color Crosshair color (optional)
 */
...
wxPoint2DDouble Polygon::Center()
{
    if(mPoints.size() < 3)
    {
        // Our polygon MUST have at least three points
        Assert(false,
               L"You have to specify a shape when using Polygon. At least three points must be provided.",
               L"https://facweb.cse.msu.edu/cbowen/cse335/polygon/c/");
